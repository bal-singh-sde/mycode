...
def get_ip_data():
    ...
    input_day = input("what day is it today?")
    input_device = input("What typ of computer are you working on?")
    d = {"IP": input_ip, "driver": input_driver, "Day": input_day, "Device": input_device}
    return d
